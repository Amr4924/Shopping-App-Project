    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _buildTitleSection(title: 'products'),
          ...
          Container(
            ...
            child: _buildProdutsList(context: context, products: products),
          ),
          const SizedBox(height: 30),

          _buildTitleSection(title: 'hot_offers'),
    ...
    child: ListView(
      children: [
        ...
        ListTile(
          ...
          title: Text(tr('log_out'),style: const TextStyle(fontWeight: FontWeight.bold),),
...
Widget _buildFeaturedProduct({required String img}) {
  return Container(
    clipBehavior: Clip.antiAlias,
    decoration: BoxDecoration(
      color: Colors.white,
